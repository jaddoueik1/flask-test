...
class eco_affaire:
    ...
    def l_cylindre(self, Npf, nb_rangeco, nb_rangaffaire, rang_AV, rang_AR):
        ...
        for i in L:
            Lpax_inch = Lpax_inch+[nb_rangeco*32+nb_rangaffaire*36+i]

        for i in Lpax_inch:
            Lcyl_m = Lcyl_m+[(i-(rang_AR*36+rang_AV*32))*0.0254]
    ...
    def draw(self,  nfront, nfront_reduit_AR, rang_affaire_cycl, rang_affaire_AV, rang_eco_cyl, rang_eco_AV, rang_eco_nonreduit_AR, rang_eco_reduit_AR, X_debut_cyl, X_fin_cyl, Y_debut_cyl, X_fuselage, Y_fuselage, Y_fuselage_sym, X, Y, Y_sym, X_EH, Y_EH, Y_EH_sym, X_nac, Y_nac, Y_nac_sym, X_av, Y_av, X_ar, Y_ar, XEV, YEV, xa, ya):
            ...
            if nfront-1 == 4:
                ...
                if nfront-1 == 5:
                    ...
                    while j > 0:
                        ...
                        ax[0].add_patch(Rectangle((X_debut_cyl+i, Y_debut_cyl-(((62/3)+1+(
        ...
        if j != 0:
            ...
            if nfront-1 == 4:
                ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(
                    ((42/2)+1)/39.3700787)), 36/39.3700787, 21/39.3700787, fc='none', color='firebrick'))
                ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(
                    ((42/2)+(42/2)+1)/39.3700787)), (36)/39.3700787, (21)/39.3700787, fc='none', color='firebrick'))
                ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((42/2)+(
                    42/2)+(42/2)+1)/39.3700787)), 36/39.3700787, 21/39.3700787, fc='none', color='firebrick'))
                ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((42/2)+19+(42/2)+(
                    42/2)+1+(42/2)+19)/39.3700787)), (36)/39.3700787, (21)/39.3700787, fc='none', color='firebrick'))
                i = i+36/39.3700787
                j = j-1
            if nfront-1 == 5:
                while j > 0:
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(
                        ((62/3)+1)/39.3700787)-haut), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((62/3)+1+(
                        62/3))/39.3700787)-haut), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((62/3)+1+(
                        62/3)+(62/3))/39.3700787)-haut), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((42/2)+(62/3)+1+(62/3)+(
                        62/3)+19+(62/4))/39.3700787)+bas), (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-((2*(42/2)+(62/3)+1+(
                        62/3)+(62/3)+19+(62/4))/39.3700787)+bas), (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                    i = i+36/39.3700787
            ...
            if nfront-1 == 6:
                ...
                while j > 0:
                    ...
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((62/3)+1+(
                        62/3))/39.3700787)-haut), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((62/3)+1+(
                        62/3)+(62/3)+29)/39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ...
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((62/3)+(62/3)+(
                        62/3)+1+(62/3)+(62/3)+29)/39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((42/2)+(42/2)+29+(62/3)+(62/3)+(
                        62/3)+29+(42/2)+(42/2)+1)/39.3700787)+bas), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    bas = bas+(62/6)/39.3700787
                    haut = haut+(62/6)/39.3700787
                    i = i+36/39.3700787
                    j = j-1
            ...
            if nfront-1 == 7:
                ...
                while j > 0:
                    ...
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(
                        ((42/2)+1)/39.3700787)-haut), (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((42/2)+(
                        42/2)+1)/39.3700787)-haut), (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((62/3)+19+(42/2)+(
                        42/2)+1+(82/8))/39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((62/3)+(62/3)+19+(
                        42/2)+(42/2)+1+(82/8))/39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((62/3)+(62/3)+(62/3)+19+(
                        42/2)+(42/2)+1+(82/8))/39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((42/2)+19+(62/3)+(62/3)+(
                        62/3)+19+(42/2)+(42/2)+1+19)/39.3700787)+bas), (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl+(rang_eco_AV*32/39.3700787)+i, Y_debut_cyl-(((42/2)+(42/2)+19+(62/3)+(62/3)+(
                        62/3)+19+19+(42/2)+(42/2)+1)/39.3700787)+bas), (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                    bas = bas+(62/6)/39.3700787
                    haut = haut+(62/6)/39.3700787
                    i = i+36/39.3700787
                    j = j-1
        ...
        if rang_affaire_cycl != 0:

            if nfront-1 == 4:

                while j > 0:
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((62/3)+1)/39.3700787)),
                                    36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ...
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((62/3)+(62/3)+(62/3)+1) /
                                    39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
            ...
            if nfront-1 == 5:
                if 160 <= self.npax:
                    while j > 0:
                        ...
                        ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((42/2)+(62/3)+1+(62/3)+(62/3)+30+(
                            62/4))/39.3700787)), (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                        ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-((2*(42/2)+(62/3)+1+(62/3)+(62/3)+30+(
                            62/4))/39.3700787)), (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                        i = i+36/39.3700787
                        j = j-1
                else:
                    while j > 0:
                        ...
                        ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((62/3)+1+(62/3)+(
                            62/3))/39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                        ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((42/2)+(62/3)+1+(62/3)+(62/3)+19+(
                            62/4))/39.3700787)), (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                        ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-((2*(42/2)+(62/3)+1+(62/3)+(62/3)+19+(
                            62/4))/39.3700787)), (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                        i = i+36/39.3700787
                        j = j-1
            ...
            if nfront-1 == 6:
                ...
                while j > 0:
                    ...
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((62/3)+1+(62/3))/39.3700787)),
                                    36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((62/3)+1+(62/3)+(
                        62/3)+29)/39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((62/3)+(62/3)+1+(62/3)+(
                        62/3)+29)/39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((62/3)+(62/3)+(62/3)+1+(62/3)+(
                        62/3)+29)/39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
            ...
            if nfront-1 == 7:
                ...
                while j > 0:
                    ...
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((42/2)+1)/39.3700787)),
                                    (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((42/2)+(42/2)+1)/39.3700787)),
                                    (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((62/3)+19+(42/2)+(42/2)+1+(
                        82/8))/39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((62/3)+(62/3)+19+(42/2)+(42/2)+1+(
                        82/8))/39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((62/3)+(62/3)+(62/3)+19+(42/2)+(
                        42/2)+1+(82/8))/39.3700787)), 36/39.3700787, (62/3)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((42/2)+19+(62/3)+(62/3)+(62/3)+19+(42/2)+(
                        42/2)+1+19)/39.3700787)), (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-i, Y_debut_cyl-(((42/2)+(42/2)+19+(62/3)+(62/3)+(62/3)+19+19+(
                        42/2)+(42/2)+1)/39.3700787)), (36)/39.3700787, (42/2)/39.3700787, fc='none', color='firebrick'))
        ...
        if rang_eco_cyl != 0:
            ...
            if nfront == 5:
                ...
                while X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i > X_fin_cyl:
                    ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-(
                    ...
                    ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-(((42/2)+(
                        62/3)+1+(62/3)+(62/3)+19)/39.3700787)), (32)/39.3700787, (42/2)/39.3700787, fc='none', color='black'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-(((42/2)+(42/2)+(
            ...
            if nfront == 6:
                if 160 <= self.npax:
                    while X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i > X_fin_cyl:
                        ...
                        ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-(
                            ((62/3)+1+(62/3)+(62/3))/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-(((62/3)+(
                            62/3)+1+(62/3)+(62/3)+29)/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-(((62/3)+(62/3)+(
                            62/3)+1+(62/3)+(62/3)+29)/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-(((62/3)+(62/3)+(
                            62/3)+(62/3)+1+(62/3)+(62/3)+29)/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
            ...
            if nfront == 7:
                ...
                while X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i > X_fin_cyl:
                    ...
                    ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-(((62/3)+(62/3)+(
                        62/3)+29+(42/2)+(42/2)+1)/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-(((42/2)+29+(62/3)+(
                        62/3)+(62/3)+29+(42/2)+(42/2)+1)/39.3700787)), (32)/39.3700787, (42/2)/39.3700787, fc='none', color='black'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-(((42/2)+(42/2)+29+(62/3)+(
                        62/3)+(62/3)+29+(42/2)+(42/2)+1)/39.3700787)), (32)/39.3700787, (42/2)/39.3700787, fc='none', color='black'))
            ...
            if nfront == 8:
                ...
                while X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i > X_fin_cyl:
                    ...
                    ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-((((82/4))+(
                        (82/4))+19+(42/2)+(42/2)+1)/39.3700787)), 32/39.3700787, (82/4)/39.3700787, fc='none', color='black'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-((((82/4))+((82/4))+(
                        (82/4))+19+(42/2)+(42/2)+1)/39.3700787)), 32/39.3700787, (82/4)/39.3700787, fc='none', color='black'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-((((82/4))+(82/4)+(
                        (82/4))+((82/4))+19+(42/2)+(42/2)+1)/39.3700787)), 32/39.3700787, (82/4)/39.3700787, fc='none', color='black'))
                    ax[0].add_patch(Rectangle((X_debut_cyl-(rang_affaire_cycl*38/39.3700787)-i, Y_debut_cyl-((((82/4))+(82/4)+((82/4))+(
        ...
        if rang_eco_reduit_AR != 0:
            ...
            if nfront_reduit_AR == 2:
                if 170 <= self.npax:
                    while j > 0:
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            ((42/2)+63/2+1)/39.3700787)), 32/39.3700787, 21/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            ((42/2)+(42/2)+1+63/2)/39.3700787)), (32)/39.3700787, (21)/39.3700787, fc='none', color='black'))
                        i = i+32/39.3700787
                        j = j-1
                else:
            ...
            if nfront_reduit_AR == 3:
                if nfront == 7:
                    while j > 0:
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (2*42/2+1)/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (42+29+2*63/3+1)/39.3700787)), (32)/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (1+42+29+29+62+62/3)/39.3700787)), (32)/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        i = i+32/39.3700787
                        j = j-1
                if nfront == 8:
                    while j > 0:
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (2*42/2+1)/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (42+29+2*82/4+1)/39.3700787)), (32)/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (1+42+29+29+82)/39.3700787)), (32)/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        i = i+32/39.3700787
                        j = j-1
                else:
                    while j > 0:
            ...
            if nfront_reduit_AR == 4:
                if 170 <= self.npax:
                    while j > 0:
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            ((42/2)+62/3+63/6+1)/39.3700787)), 32/39.3700787, 21/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (2*(42/2)+62/3+63/6+1)/39.3700787)), (32)/39.3700787, (21)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            ((42/2)+29+62+1)/39.3700787)), 32/39.3700787, 21/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (2*(42/2)+29+62+1)/39.3700787)), (32)/39.3700787, (21)/39.3700787, fc='none', color='black'))
            ...
            if nfront_reduit_AR == 5:
                if 170 <= self.npax < 210:
                    while j > 0:
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            ((62/3)+62/6+1)/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            ((62/3)+1+(62/3)+62/6)/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            ((62/3)+1+(62/3)+(62/3)+62/6)/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            ((42/2)+62+1+29)/39.3700787)), (32)/39.3700787, (42/2)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (2*(42/2)+62+1+29)/39.3700787)), (32)/39.3700787, (42/2)/39.3700787, fc='none', color='black'))
                        i = i+32/39.3700787
                        j = j-1
                if nfront == 7:
                    while j > 0:
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (42+1)/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (42+29+1+(62/3))/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (42+29+1+2*(62/3))/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (42+29+1+3*(62/3))/39.3700787)), (32)/39.3700787, (42/2)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (42/2+(42)+62+1+2*29)/39.3700787)), (32)/39.3700787, (42/2)/39.3700787, fc='none', color='black'))
                        i = i+32/39.3700787
                        j = j-1
                if nfront == 8:
                    while j > 0:
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (42+1)/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (42+29+1+(82/4))/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (42+29+1+2*(82/4))/39.3700787)), 32/39.3700787, (62/3)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            (42+29+1+3*(82/4))/39.3700787)), (32)/39.3700787, (42/2)/39.3700787, fc='none', color='black'))
                        ax[0].add_patch(Rectangle((X_fin_cyl-(rang_eco_nonreduit_AR*32/39.3700787)-i, Y_debut_cyl-(
                            ((42)+82+1+2*29)/39.3700787)), (32)/39.3700787, (42/2)/39.3700787, fc='none', color='black'))
                        i = i+32/39.3700787
                        j = j-1
                else:
                    while j > 0:
    ...
    def terminer(self):
        ...
        while i < 10:
            ...
            for nfront in self.npf():
                ...
                while nb_places_tot_affaire-x > nfront-1:
                    ...
                    place_AV = ((nb_rang_AV-Rang_reduit_AV)*(nfront-1)) + \
                        Rang_reduit_AV*nfront_reduit_AV

                    if nb_places_tot_affaire-x < place_AV:
                        places_affaire_AV = nb_places_tot_affaire-x
                        place_eco_AV = place_AV-places_affaire_AV
                    else:
                        places_affaire_AV = place_AV
                        place_eco_AV = 0
                    ...
                    while nfront-i_ar >= 0:
                        ...
                        places_cyl_eco = self.npax - \
                            (place_AR+places_cyl_affaire +
                             places_affaire_AV+place_eco_AV)

                        place_cylindre = places_cyl_eco+places_cyl_affaire
                        nb_rang_cylindre = (
                            places_cyl_eco/nfront)+(places_cyl_affaire/(nfront-1))

                        if (places_cyl_eco % nfront)+(places_cyl_affaire % (nfront-1)) == 0 and places_cyl_affaire > 0:
                            ...
                            rang_affaire = (
                                (places_cyl_affaire+places_affaire_AV)/(nfront-1))
                            place_totale = place_AV+place_AR+place_cylindre

                            rang_totale = rang_eco+rang_affaire

                            l_cylindre_m = self.l_cylindre(
                                nfront, rang_eco, rang_affaire, nb_rang_AV, nb_rang_AR)[0]
                            lpax_inch = self.l_cylindre(
                                nfront, rang_eco, rang_affaire, nb_rang_AV, nb_rang_AR)[1]
                                    ...
                                    for larav in self.rayon(nfront)[0]:
                                        for rext in self.rayon(nfront)[1]:
                                            ...
                                            if rapport > 10 and rapport < mini1:
                                                ...
                                                rang_affairecycl = places_cyl_affaire / \
                                                    (nfront-1)
                                                rang_affaireAV = places_affaire_AV / \
                                                    (nfront-1)
            ...
            while state == False:
                ...
                if (0 <= (Mcarb-F)/(F)*100 <= 0.5):
                    ...
                    MTOW = MTOW+100
                    MZFW = MTOW-F
                    sref1 = ((MTOW-F/2)*9.81)/((1.4)/2 *
                                               self.P*math.pow(self.mach, 2)*Czopt)
        ...
        self.draw( nfront1, nfront_reduit, rang_affairecycl, rang_affaireAV, rang_ecocycl, rangeco_AV, rangeco_nonreduitAR,
